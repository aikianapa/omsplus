<form id="commentsEditForm" data-wb-form="comments" data-wb-item="{{_item}}" class="form-horizontal" role="form">
    ...
    <div data-wb-where='"{{_ENV[route][mode]}}"="edit"'>
        ...
        <div class="form-group row" data-wb-allow="admin">
            <label class="col-sm-3 form-control-label">{{_LANG[user]}}</label>
            <div class="col-sm-9">
                <select class="form-control select2" role="foreach" data-wb-form="users" data-wb-where='active="on" AND fullname > "" ' name="_creator" placeholder="{{_LANG[user]}}">
                    <option value="{{id}}">
                        [ {{id}} ] - {{fullname}}
                    </option>
                   </select>
        ...
        <div class="form-group row" data-wb-allow="admin">
            ...
            <div class="col-sm-9">
                <select class="form-control select2" name="gender" placeholder="Пол">
                    <option value="male" data-image="/tpl/img/avamale.png"> мужской</option>
                    <option value="female" data-image="/tpl/img/avafemale.png"> женский</option>
                   </select>
            </div>
        </div>
    </div>
